...
import { BookOpen, ShoppingBag, FolderOpen, Tag, TrendingUp } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <div className="mt-8 rounded-2xl border border-emerald/10 bg-white p-5 shadow-soft"><p className="text-sm text-muted">به پنل مدیریت خوش آمدید. از منوی کناری برای مدیریت کتاب‌ها، محصولات و تنظیمات سایت استفاده کنید.</p></div>
    </div>
  );
}
